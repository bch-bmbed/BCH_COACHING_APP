...
test('deux champs du profil modifiés le même jour sont réunis',()=>{
  ...
  assert.equal(merged.conflicts.length,0);assert.deepEqual(M.goalsAt(merged.profile,'2026-09-15'),{plannedIntake:1900,base:2400,target:400,maintenance:null,includedActivity:null,adaptive:false,routine:null});
